...
private:
    ...
    std::string m_zmq_port;

    // people count metadata
    std::string m_people_count_type;
    std::string m_people_count;
...
private:
    ...
    // line drawing (one segment)
    std::string m_point1_x;
    std::string m_point1_y;
    std::string m_point2_x;
    std::string m_point2_y;
